...
var DICTIONARY_DOCS = {
	...
	"PUBLISH_STATUS_INREVIEW": "In review"
};
...
var DICTIONARY_EVENT_DESTINATIONS = {
	"MESSAGE_CREATE_SUCCESS": "Event destination has been created successfully.",
	"MESSAGE_CREATE_FAIL": "Failed to create event destination.",
	"MESSAGE_UPDATE_SUCCESS": "Event destination has been updated successfully.",
	"MESSAGE_UPDATE_FAIL": "Failed to update event destination.",
	"MESSAGE_DELETE_SUCCESS": "Event destination has been deleted successfully.",
	"MESSAGE_DELETE_FAIL": "Failed to delete event destination.",
};